      ...
      <div className="relative z-[1] mx-auto w-full max-w-[900px]">
        ...
        <div className="mt-8">
          ...
          <a
            ...
            className="mt-7 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-glow)] px-7 py-3.5 text-sm font-semibold text-[var(--bg-base)] shadow-[0_12px_32px_rgba(201,169,110,0.25)] transition-shadow hover:shadow-[0_12px_40px_rgba(201,169,110,0.35)]"
          >
